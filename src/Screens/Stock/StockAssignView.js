        ...
        <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
          <div className="flex flex-col bg-[#22543d] dark:bg-[#22543d] md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            ...
            <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
              ...
              <Link
                to={`${routePaths.STOCKASSIGNFORM}${add}`}
                type="button"
              ...
              <tbody>
                <tr className="border-b dark:border-gray-700">
                  ...
                  <td className="px-4 py-3">
                    <Link to={`${routePaths.STOCKASSIGNFORM}${edit}`}>
                      <Tooltip title="Edit">
                ...
                <tr className="border-b dark:border-gray-700">
                  ...
                  <td className="px-4 py-3">xyz</td>
                  <td className="px-4 py-3">
                    <Link to={`${routePaths.ADDUSERS}${edit}`}>
                      <Tooltip title="Edit">
                        <EditIcon className="text-green-900" />
                      </Tooltip>
                    </Link>
...
export default StockAssignView;
