...
const CategoryView = () => {
  ...
  var templateData = masterheaders[template];
    // useEffect(()=>{
    //     axios.post(url+'/api/getcategory',{id:id}).then(res=>console.log(res))
    // },[])
    return (
    <MasterViewTemplate
      to={routePaths.ADDCATEGORIES}
      templateData={templateData}
      template={template}
      _url={"/api/getcategory"}
    ...
    />
        ...
        //                     {/* <Link to={`/home/mastersComp/Categories/categoryaddform/${add}`}> */}
        //                     <Link to={`${routePaths.ADDCATEGORIES}${add}`} type="button" className="flex items-center justify-center text-gray-600 bg-white hover:bg-primary-800 focus:ring-green-900 font-medium rounded-full hover:scale-110 text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none  transition duration-0 hover:duration-500 hover:shadow-lg dark:focus:ring-primary-800 dark:bg-gray-800 dark:text-white ">
        //                         <PlusOutlined />
        //                         Add categories
        //                     </Link>
        ...
        //                             <th scope="col" className="px-4 py-3 text-green-900  w-1/4 dark:text-gray-300">Category Name</th>
        //                             <th scope="col" className="px-4 py-3 text-green-900  w-1/4 dark:text-gray-300">Action</th>
        ...
        //                                 <Link to={`/home/mastersComp/Categories/categoryaddform/${edit}`}>
        //                                     <Tooltip title="Edit">
