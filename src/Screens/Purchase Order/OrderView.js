						...
						<table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
							...
							<tbody>
								<tr className="border-b dark:border-gray-700">
									<th
										scope="row"
										className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-gray-300"
									>
										1
									</th>
									<td className="px-4 py-3 w-1/4">abc</td>
									<td className="px-4 py-3 w-1/4">5392572687</td>
								...
								<tr className="border-b dark:border-gray-700">
									...
									<td className="px-4 py-3">5392572687</td>
