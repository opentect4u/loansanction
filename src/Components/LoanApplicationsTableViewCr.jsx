...
function LoanApplicationsTableViewCr({
	loanAppData,
	setSearch,
	title,
	isForwardLoan = false,
		...
		<>
			...
			>
				<table className="w-full text-sm text-left rtl:text-right shadow-lg text-green-900dark:text-gray-400">
					<thead className=" text-md text-gray-700 capitalize bg-teal-100 dark:bg-gray-700 dark:text-gray-400">
						<tr>
									...
									<td className="px-6 py-4">
										<Link
											to={
												...
												routePaths.CREDIT_MGR_EDIT_APPLICATION +
												item?.application_no
											...
											// to={}
										>
											<EditOutlined className="text-md text-teal-800" />
										</Link>
									</td>
								</tr>
							))}
...
export default LoanApplicationsTableViewCr
